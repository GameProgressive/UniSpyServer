...
namespace GameSpyLib.Network
{
    ...
    public class TcpSession
    {
        ...
        /// <summary>
        /// Some server disconnects clients after send, we use this to determine whether disconnecting clients
        /// </summary>
        protected bool DisconnectAfterSend = true;
        /// <summary>
        ...
        public virtual bool SendAsync(byte[] buffer, long offset, long size)
        {
            ...
            if (LogWriter.Log.DebugSockets)
                LogWriter.Log.Write(LogLevel.Debug, "{0} [Send] TCP data: {1}", Server.ServerName, Encoding.UTF8.GetString(buffer));
        ...
        private void ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            if (size > 0)
            {
                ...
                if (LogWriter.Log.DebugSockets)
                    LogWriter.Log.Write(LogLevel.Debug, "{0} [Recv] TCP data: {1}", Server.ServerName, Encoding.UTF8.GetString(_receiveBuffer.Data, 0, (int)size));
