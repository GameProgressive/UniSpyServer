...
namespace GameSpyLib.Network
{
    ...
    public class TcpServer : IDisposable
    {
        ...
        public TcpServer(string serverName, IPAddress address, int port) : this(new IPEndPoint(address, port)) { ServerName = '[' + serverName + ']'; }
        /// <summary>
        /// Initialize TCP server with a given IP address and port number
        /// </summary>
        /// <param name="address">IP address</param>
        ...
        /// <summary>
        /// Get how many sessions are alive now
        /// </summary>
        /// <returns>Alive session numbers</returns>
        public int CountAvailbleSession()
        {
