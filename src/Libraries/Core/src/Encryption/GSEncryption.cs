...
{
    public sealed class GameSpyCTX
    {
        public byte Buffer1;
        public byte Buffer2;
    ...
    /// </summary>
    public sealed class GSEncryption : ICryptography
    {
        ...
        public static byte[] Handle(GameSpyCTX ctx, byte[] data)
        {
        ...
        public static void Init(GameSpyCTX ctx, string challengeKey, string secretKey)
        {
        ...
        public GameSpyCTX ClientCtx { get; private set; }
        public GameSpyCTX ServerCtx { get; private set; }
        public GSEncryption(string gameSecretKey)
        {
            ClientCtx = new GameSpyCTX();
            ServerCtx = new GameSpyCTX();
