...
class SakeTests(unittest.TestCase):
    ...
    def test_update_record(self):
        ...
        self.assertEqual("MyByte", request.values['RecordField'][0]["name"])
        self.assertEqual(
            "123", request.values["RecordField"][0]['value']["byteValue"]['value'])
    ...
    def test_create_record(self):
        ...
        self.assertEqual(
            "MyAsciiString", request.values['RecordField']['name'])
        self.assertEqual("asciiStringValue", list(
            request.values['RecordField']['value'])[0])
        self.assertEqual(
            "this is a record", request.values['RecordField']['value']["asciiStringValue"]['value'])
