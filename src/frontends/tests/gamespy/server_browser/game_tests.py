...
class GameTest(unittest.TestCase):
    ...
    def test_anno1701_20221104(self):
        qr_raw = {
            "qr1": b"\t\x00\x00\x00\x00anno1701\x00",
    ...
    def test_aarts_20230618(self):
        sb_raw = b"\x00\xb8\x00\x01\x03\x00\x00\x00\x00aarts\x00aarts\x00F|Cy9!&w\x00\\hostname\\gamemode\\hostport\\hostname\\gamename\\gametype\\gamever\\mapname\\numplayers\\maxplayers\\gamemode\\password\\groupid\\mapsessiontype\\mapids\\internet\x00\x00\x00\x00\x04"
        client = create_v2_client()
        client.on_received(sb_raw)
