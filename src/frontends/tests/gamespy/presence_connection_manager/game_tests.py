...
class GameTest(unittest.TestCase):
    ...
    def test_civilization_4(self) -> None:
        raw_requests = [
            ...
            b"\\login\\\\challenge\\xMsHUXuWNXL3KMwmhoQZJrP0RVsArCYT\\uniquenick\\civ4-tk\\userid\\25\\profileid\\26\\response\\7f2c9c6685570ea18b7207d2cbd72452\\firewall\\1\\port\\0\\productid\\10435\\gamename\\civ4\\namespaceid\\17\\sdkrevision\\1\\id\\1\\final\\",
        ]
    ...
    def test_conflict_global_storm(self) -> None:
        ...
        raw_requests = [
            b"\\login\\\\challenge\\KMylyQbZfqzKn9otxx32q4076sOUnKif\\user\\cgs1@cgs1@rs.de\\response\\c1a6638bbcfe130e4287bfe4aa792949\\port\\-15737\\productid\\10469\\gamename\\conflictsopc\\namespaceid\\1\\id\\1\\final\\",
            b"\\inviteto\\\\sesskey\\58366\\products\\1038\\final\\",
        ]
        client = create_client()
        for x in raw_requests:
            client.on_received(x)
