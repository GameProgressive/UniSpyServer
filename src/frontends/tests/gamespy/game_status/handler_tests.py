...
from frontends.gamespy.protocols.game_status.applications.handlers import AuthPlayerHandler, SetPlayerDataHandler, UpdateGameHandler
...
class HandlerTests(unittest.TestCase):
    ...
    def test_set_player_data_20230329(self):
        ...
        self.assertEqual(
            "|title||victories|0|timestamp|37155|league|Team17|winner||crc|-1|player_0|spyguy|ip_0||pid_0|0|auth_0|[00]", request.report)
    ...
    def test_get_player_data(self):
        raw = "\\getpd\\\\pid\\0\\ptype\\0\\dindex\\1\\keys\\hello\x01hi\\lid\\1\\final\\"
