...
from servers.webservices.modules.direct2game.contracts.requests import (
    GetPurchaseHistoryRequest,
    GetStoreAvailabilityRequest,
)
from servers.webservices.modules.direct2game.contracts.responses import (
    GetPurchaseHistoryResponse,
    GetStoreAvailabilityResponse,
)
from servers.webservices.modules.direct2game.contracts.results import (
