...
class CheckHandler(CmdHandlerBase):
    _result_cls: type[CheckResult] = CheckResult
...
class NewUserHandler(CmdHandlerBase):
    _result_cls: type[NewUserResult] = NewUserResult
...
class NicksHandler(CmdHandlerBase):
    _result_cls: type[NicksResult] = NicksResult
...
class OthersHandler(CmdHandlerBase):
    ...
    _result_cls: type[OthersResult] = OthersResult
...
class OthersListHandler(CmdHandlerBase):
    _result_cls: type[OthersListResult] = OthersListResult
...
class SearchHandler(CmdHandlerBase):
    ...
    """
    _result_cls: type[SearchResult] = SearchResult
...
class SearchUniqueHandler(CmdHandlerBase):
    _result_cls: type[SearchUniqueResult] = SearchUniqueResult
...
class UniqueSearchHandler(CmdHandlerBase):
    _result_cls: type[UniqueSearchResult] = UniqueSearchResult
...
class ValidHandler(CmdHandlerBase):
    _result_cls: type[ValidResult] = ValidResult
