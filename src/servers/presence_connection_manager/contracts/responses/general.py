...
from servers.presence_connection_manager.applications.client import (
    LOGIN_TICKET,
    SESSION_KEY,
)
...
from servers.presence_search_player.contracts.requests import (
    NewUserRequest,
)
from servers.presence_search_player.contracts.responses import (
    NewUserResponse as NUR,
)
from servers.presence_search_player.contracts.results import NewUserResult
