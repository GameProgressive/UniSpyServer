...
class HandlerTests(unittest.TestCase):
    ...
    def test_sdk_login_remote_auth_fake_data(self):
        raw = {"raw_request": "",
               "version": 1, "partner_code": 0, "namespace_id": 0, "auth_token": "example_auth", "challenge": "LH8c.DLe", "game_id": 0, "client_ip": "172.19.0.4", "server_id": "950b7638-a90d-469b-ac1f-861e63c8c613", "client_port": 57502}
        request = LoginRemoteAuthRequest.model_validate(raw)
        handler = LoginRemoteAuthHandler(request)
        handler.handle()
        handler.response
