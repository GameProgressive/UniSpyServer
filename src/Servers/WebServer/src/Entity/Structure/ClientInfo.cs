...
namespace UniSpyServer.Servers.WebServer.Entity.Structure
{
    ...
    {
        public const string PeerKeyExponent = "000000";
        public const string PeerKeyModulus = 
        ...
        public const string Signature = "";
        public ClientInfo( )
        {
        }
    }
