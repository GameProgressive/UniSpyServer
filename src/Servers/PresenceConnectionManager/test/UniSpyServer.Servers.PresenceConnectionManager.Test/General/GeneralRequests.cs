namespace UniSpyServer.Servers.PresenceConnectionManager.Test.General
{
    public static class GeneralRequests
    {
        ...
        public const string LoginAuthtoken = @"\login\\challenge\xxxx\authtoken\xxxx\userid\0\profileid\0\partnerid\0\response\xxxxx\firewall\1\port\0000\productid\0\gamename\gmtest\sdkrevision\3\quiet\0\id\1\final\";

        public const string LoginUniquenick = @"\login\\challenge\xxxx\uniquenick\spyguy\userid\0\profileid\0\namespaceid\0\partnerid\0\response\xxxxx\firewall\1\port\0000\productid\0\gamename\gmtest\sdkrevision\3\quiet\0\id\1\final\";

        public const string LoginUser = @"\login\\challenge\xxxx\user\spyguy@spyguy@unispy.org\userid\0\profileid\0\partnerid\0\namespaceid\0\response\xxxxx\firewall\1\port\0000\productid\0\gamename\gmtest\sdkrevision\3\quiet\0\id\1\final\";

        //public const string Logout = @"";

        //public const string NewUser = @"\newuser\email\spyguy@unispy.org\nick\spyguy\passwordenc\4a7d1ed414474e4033ac29ccb8653d9b\productid\0\gamename\gmtest\namespaceid\0\uniquenick\spyguy\cdkeyenc\xxxx\id\1\final\";
    }
}
