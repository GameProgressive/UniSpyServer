...
namespace UniSpy.Server.Chat.Handler.CmdHandler.Channel
{
    ...
    public sealed class SetChannelKeyHandler : ChannelHandlerBase
    {
        ...
        public SetChannelKeyHandler(IShareClient client, SetChannelKeyRequest request) : base(client, request)
        {
        ...
        protected override void DataOperation()
        {
            ...
            _result.ChannelUserIRCPrefix = _user.Client.Info.IRCPrefix;
        }
