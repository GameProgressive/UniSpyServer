...
{
    public record GameServerInfo2 : LinqToRedis.RedisKeyValueObject
    {
        [RedisKey]
        ...
        public GameServerInfo2() : base(TimeSpan.FromMinutes(3))
        {
        }
    }
    public class RedisClient : LinqToRedis.RedisClient<GameServerInfo2>
    {
