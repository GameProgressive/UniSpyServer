...
namespace UniSpyServer.Servers.QueryReport.Test
{
    public static class TestClasses
    {
        ...
        public static QueryReport.Entity.Structure.Client CreateQRClient(string ipAddress = "192.168.1.1", int port = 9999)
        {
            ...
            return new QueryReport.Entity.Structure.Client(qrSessionMock.Object);
        }
    }
}