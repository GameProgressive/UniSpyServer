...
namespace UniSpyServer.Servers.NatNegotiation.Test
{
    public class GameTest
    {
        ...
        /// </summary>
        public void GameSpySDK20221117()
        {
            new RedisClient().Db.Execute("FLUSHALL");
            var clients = new Dictionary<string, IClient>()
            {
