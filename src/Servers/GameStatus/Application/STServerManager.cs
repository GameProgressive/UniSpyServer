...
namespace StatsTracking.Application
{
    ...
    /// </summary>
    public class STServerManager : ServerManagerBase
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="serverName">Server name in config file</param>
        public STServerManager(string serverName) : base(serverName)
        {
        }
        ...
        protected override void StartServer(ServerConfig cfg)
        {
            ...
            {
                Server = new STServer(IPAddress.Parse(cfg.ListeningAddress), cfg.ListeningPort).Start();
