...
namespace Chat
{
    ...
    public class ServerManager : IDisposable
    {
        ...
        private ChatServer peerChatServer = null;
        ...
        public void StartServer(ServerConfiguration cfg)
        {
            ...
            {
                case "CHAT":
                    peerChatServer = new ChatServer(cfg.Name, databaseDriver, new IPEndPoint(IPAddress.Parse(cfg.Hostname), cfg.Port), cfg.MaxConnections);
