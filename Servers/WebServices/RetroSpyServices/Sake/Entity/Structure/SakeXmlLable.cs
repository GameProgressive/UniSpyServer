...
namespace WebServices.RetroSpyServices.Sake.Entity.Structure
{
    public class SakeXmlLable
    {
        ...
        public const string IntValue = SakeNameSpace + "intValue";
        public const string Int64Value = SakeNameSpace + "int64Value";
        public const string FloatValue = SakeNameSpace + "floatValue";
        public const string AsciiStringValue = SakeNameSpace + "asciiStringValue";
        public const string UnicodeStringValue = SakeNameSpace + "unicodeStringValue";
        public const string BooleanValue = SakeNameSpace + "booleanValue";
        public const string DateAndTimeValue = SakeNameSpace + "dateAndTimeValue";
