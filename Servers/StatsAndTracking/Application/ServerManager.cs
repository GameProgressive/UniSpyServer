...
namespace StatsAndTracking
{
    ...
    public class ServerManager : IDisposable
    {
        ...
        private GStatsServer statsServer = null;
        ...
        {
            return statsServer != null && !statsServer.Disposed;
        }
        ...
        public void StartServer(ServerConfiguration cfg)
        {
            ...
            {
                case "GSTATS":
                    statsServer = new GStatsServer(cfg.Name, databaseDriver, new IPEndPoint(IPAddress.Parse(cfg.Hostname), cfg.Port), cfg.MaxConnections);
