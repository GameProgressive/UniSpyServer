...
namespace MasterServer
{
    internal class Program
    {
        ...
        private static ServerBrowser.Application.ServerManager Manager = null;
        private static QueryReport.Application.ServerManager Manager2 = null;
        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Manager = new ServerBrowser.Application.ServerManager(ServerName);
                Manager2 = new QueryReport.Application.ServerManager(ServerName2);
