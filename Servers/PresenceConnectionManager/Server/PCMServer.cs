...
{
    public class PCMServer : TcpServer
    {
        /// <summary>
        ...
        /// </summary>
        public static ConcurrentQueue<PCMSession> PlayerStatusQueue { get; private set; } = new ConcurrentQueue<PCMSession>();
        ...
        /// </summary>
        public PCMServer(string serverName, DatabaseDriver driver, IPAddress address, int port) : base(serverName, address, port)
        {
