...
namespace RetroSpyServer.Servers.NatNeg.Structures
{
    public static class NatNegInfo
    {
        ...
        public static byte NN_INIT = 0x00;

        public static byte NN_INITACK = 0x01;

        public static byte NN_ERTTEST = 0x02;

        public static byte NN_ERTACK = 0x03;

        public static byte NN_STATEUPDATE = 0x04;

        public static byte NN_CONNECT = 0x05;

        public static byte NN_CONNECT_ACK = 0x06;

        public static byte NN_CONNECT_PING = 0x07;

        public static byte NN_BACKUP_TEST = 0x08;

        public static byte NN_BACKUP_ACK = 0x09;

        public static byte NN_ADDRESS_CHECK = 0x0A;

        public static byte NN_ADDRESS_REPLY = 0x0B;

        public static byte NN_NATIFY_REQUEST = 0x0C;

        public static byte NN_REPORT = 0x0D;

        public static byte NN_REPORT_ACK = 0x0E;

        public static byte NN_PREINIT = 0x0F;

        public static byte NN_PREINIT_ACK = 0x10;
